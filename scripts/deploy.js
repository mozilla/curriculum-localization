...
shell.echo(`/*\n`).toEnd(`.gitignore`);
shell.echo(`!assets\n`).toEnd(`.gitignore`);
shell.echo(`!compiled.css\n`).toEnd(`.gitignore`);
shell.echo(`!about\n`).toEnd(`.gitignore`);
shell.echo(`!contact\n`).toEnd(`.gitignore`);
shell.echo(`!curriculum\n`).toEnd(`.gitignore`);
shell.echo(`!tools\n`).toEnd(`.gitignore`);
shell.echo(`!compiled.js\n`).toEnd(`.gitignore`);
...
shell.exec(`git push -f https://${process.env.GH_TOKEN}@github.com/mozilla/curriculum-localization.git gh-pages:gh-pages`);
